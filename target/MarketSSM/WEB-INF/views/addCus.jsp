    ...
    <div class="container body" style="overflow-x: hidden;overflow-y: hidden; ">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <form class="form-horizontal form-label-left" method="post" action="addCus" onsubmit="return checkall()">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                            <input id="cusid" name="cusid"  class="form-control col-md-7 col-xs-5" value="" onblur="checkid()" type="text" ><span id="demo1" style="color: red;"></span>
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                            <input id="cusname"  name="cusname" class="form-control col-md-7 col-xs-5"  value="" type="text" onblur="checkname()"><span id="demo2" style="color: red;"></span>
                        </div>
                    </div>
                    <div class="item form-group">
