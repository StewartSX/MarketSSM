    ...
    <div class="container body" style="overflow-x: hidden;overflow-y: hidden; ">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <form class="form-horizontal form-label-left" method="post" action="editCkin" >
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                            <input id="indate"  name="indate" class="form-control col-md-7 col-xs-5" value="${ckin.indate}" type="date" >
                        </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div align="center">
                        <span><font color="red">${requestScope.errorInfoEdit}</font></span>
                    </div>
