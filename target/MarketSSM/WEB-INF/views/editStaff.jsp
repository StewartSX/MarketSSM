...
<div class="container body" style="overflow-x: hidden;overflow-y: hidden; ">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            <form class="form-horizontal form-label-left"  method="post" action="editStaff" onsubmit="return checkall()" >
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input id="pwd1" name="pwd1" class="form-control col-md-7 col-xs-5" value="${staff.pwd}"  type="password" placeholder="请填写密码"  >
                    </div>
                </div>
                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-5" >密码<span >*</span>
                ...
                <div align="center">
                    <span style="color: red">${requestScope.errorInfoEditStaff}</span>
                </div>
