...
<div class="container body" style="overflow-x: hidden;overflow-y: hidden; ">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            <form action="updateSale" class="form-horizontal form-label-left">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input name="saleid" class="form-control input-small input-sm "  value="${saleid}"  type="text" readonly>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input name="proid" class="form-control input-small input-sm "  value="${proid}"  type="text" >
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input name="pname" class="form-control col-md-7 col-xs-5" value="${pname}"  type="text" >
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input name="price" class="form-control col-md-7 col-xs-5" value="${price}"  type="text" >
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input name="num" class="form-control col-md-7 col-xs-5" value="${num}"  type="text" >
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input name="total" class="form-control col-md-7 col-xs-5" value="${total}"  type="text" >
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input name="marks" class="form-control col-md-7 col-xs-5" value="${marks}"  type="text" >
                    </div>
                </div>
