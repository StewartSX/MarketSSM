...
<div class="container body" style="overflow-x: hidden;overflow-y: hidden; ">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            <form class="form-horizontal form-label-left" method="post" action="editSup" onsubmit="return checkall()">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input id="supid" name="supid"  class="form-control col-md-7 col-xs-5" value="${sup.supid}" readonly="readonly" type="text" onblur="checkid()"><span id="demo1" style="color: red;"></span>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input id="suppname"  name="suppname" class="form-control col-md-7 col-xs-5"  value="${sup.suppname}" type="text"  onblur="checkname()"><span id="demo2" style="color: red;"></span>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input id="tel"  name="tel" class="form-control col-md-7 col-xs-5"  value="${sup.tel}" type="text" onblur="checktel()"><span id="demo3" style="color: red;"></span>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input id="person"  name="person" class="form-control col-md-7 col-xs-5"  value="${sup.person}" type="text" >
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input id="address"  name="address" class="form-control col-md-7 col-xs-5"  value="${sup.address}" type="text" >
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-5">
                        <input id="emali"  name="emali" class="form-control col-md-7 col-xs-5"  value="${sup.emali}" type="text" onblur="checkemail()"><span id="demo4"  style="color: red;"></span>
                    </div>
                </div>
