        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <!-- 按钮 -->
                    <div class="row">
                        <form class="form-inline" action="selectStaff" method="post">
                            <span class="row">
                                ...
                                <a href="toAddstaff" class="btn btn-primary " role="button">新增</a>
                            </span>
                        </form>
                    </div>
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        <%--                                    首页按钮--%>
                                        <li>
                                            <a href="${app_path}/selectStaff?pn=1&staffid=${staffid}&staffname=${staffname}">
                                                首页
                                            </a>
                                        </li>
                                        ...
                                        <c:if test="${pageInfo.hasPreviousPage}">
                                            <li>
                                                <a href="${app_path}/selectStaff?pn=${pageInfo.pageNum-1}&staffid=${staffid}&staffname=${staffname}" aria-label="Previous">
                                        ...
                                        <c:forEach items="${pageInfo.navigatepageNums}" var="pageNum">
                                            ...
                                            <c:if test="${pageInfo.pageNum == pageNum}">
                                                <li class="active">
                                                    <a href="${app_path}/selectStaff?pn=${pageNum}&staffid=${staffid}&staffname=${staffname}">
                                                            ${pageNum}
                                                    </a>
                                                </li>
                                            </c:if>
                                        ...
                                        <c:if test="${pageInfo.hasNextPage}">
                                            <li>
                                                <a href="${app_path}/selectStaff?pn=${pageInfo.pageNum+1}&staffid=${staffid}&staffname=${staffname}" aria-label="Next">
                                        ...
                                        <%--                                    尾页按钮--%>
                                        <li>
                                            <a href="${app_path}/selectStaff?pn=${pageInfo.pages}&staffid=${staffid}&staffname=${staffname}">
                                                尾页
                                            </a>
                                        </li>
                                    </ul>
