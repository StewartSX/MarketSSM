            ...
            <div class="right_col" role="main">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <!-- 按钮 -->
                        <div class="row">
                            <form class="form-inline" action="selectKcxx" method="post">
                                ...
                                <table id="datatable" class="table table-striped table-bordered table-hover">
                                    ...
                                    <c:forEach items="${pageInfo.list}" var="kcxx">
                                        <tr>
                                            ...
                                            <td>${kcxx.marks}</td>
                                            <td>
                                                <form action="toGetKcxx" method="post">
                                                    <input type="hidden" name="proid" value="${kcxx.proid}">
                                                    <input type="hidden" name="num" value="${kcxx.num}">

                                                    <input type="submit" value="查看" class="btn btn-success  btn-xs">
                                                </form>
                                                <form action="toEditkcxx" method="post">
                                                    <input type="hidden" name="proid" value="${kcxx.proid}">
                                                    <input type="hidden" name="pname" value="${kcxx.pname}">
                                                    <input type="hidden" name="num" value="${kcxx.num}">
                                                    <input type="hidden" name="marks" value="${kcxx.marks}">

                                                    <input type="submit" value="进货" class="btn btn-primary btn-xs">
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
                            ...
                            <div class="col-md-6">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        <%--  首页按钮--%>
                                        <li>
                                            <a href="${app_path}/selectKcxx?pn=1&pname=${pname}&proid=${proid}">
                                                首页
                                            </a>
                                        </li>
                                        ...
                                        <c:if test="${pageInfo.hasPreviousPage}">
                                            <li>
                                                <a href="${app_path}/selectKcxx?pn=${pageInfo.pageNum-1}&pname=${pname}&proid=${proid}" aria-label="Previous">
                                        ...
                                        <c:forEach items="${pageInfo.navigatepageNums}" var="pageNum">
                                            ...
                                            <c:if test="${pageInfo.pageNum == pageNum}">
                                                <li class="active">
                                                    <a href="${app_path}/selectKcxx?pn=${pageNum}&pname=${pname}&proid=${proid}">
                                                            ${pageNum}
                                                    </a>
                                                </li>
                                            </c:if>
                                        ...
                                        <c:if test="${pageInfo.hasNextPage}">
                                            <li>
                                                <a href="${app_path}/selectKcxx?pn=${pageInfo.pageNum+1}&pname=${pname}&proid=${proid}" aria-label="Next">
                                        ...
                                        <%--尾页按钮--%>
                                        <li>
                                            <a href="${app_path}/selectKcxx?pn=${pageInfo.pages}&pname=${pname}&proid=${proid}">
                                                尾页
                                            </a>
                                        </li>
                                    </ul>
