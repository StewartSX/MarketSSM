            ...
            <div class="right_col" role="main">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <!-- 按钮 -->
                        <div class="row">
                            <form class="form-inline" action="selectType" method="post">
                                <span class="row">
                        ...
                        <div class="row">
                            <div class="x_content">
                                <table id="datatable" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td>${type.protypeid}</td>
                                        <td>${type.typename}</td>
                                        <td>
                                            <form action="toEdittype" method="post">
                                                <input type="hidden" name="protypeid" value="${type.protypeid}">
                                                <input type="hidden" name="typename" value="${type.typename}">
                            ...
                            <!-- 新增操作的模态框 -->
                            <form class="form-horizontal form-label-left"  method="post" action="addType" onsubmit="return checkall()">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div align="center">
                                                    <span><font color="red">${requestScope.errorInfoAddType}</font> </span>
                                                </div>
...
<%--                                            首页按钮--%>
                                            <li>
                                                <a href="${app_path}/selectType?pn=1&protypeid=${protypeid}&typename=${typename}">
                                                    首页
                                                </a>
                                            </li>
                                            ...
                                            <c:if test="${pageInfo.hasPreviousPage}">
                                                <li>
                                                    <a href="${app_path}/selectType?pn=${pageInfo.pageNum-1}&protypeid=${protypeid}&typename=${typename}" aria-label="Previous">
                                            ...
                                            <c:forEach items="${pageInfo.navigatepageNums}" var="pageNum">
                                                ...
                                                <c:if test="${pageInfo.pageNum == pageNum}">
                                                    <li class="active">
                                                        <a href="${app_path}/selectType?pn=${pageNum}&protypeid=${protypeid}&typename=${typename}">
                                                                ${pageNum}
                                                        </a>
                                                    </li>
                                                </c:if>
                                            ...
                                            <c:if test="${pageInfo.hasNextPage}">
                                                <li>
                                                    <a href="${app_path}/selectType?pn=${pageInfo.pageNum+1}&protypeid=${protypeid}&typename=${typename}" aria-label="Next">
                                            ...
                                            <%--尾页按钮--%>
                                            <li>
                                                <a href="${app_path}/selectType?pn=${pageInfo.pages}&protypeid=${protypeid}&typename=${typename}">
                                                    尾页
                                                </a>
                                            </li>
                                        </ul>
